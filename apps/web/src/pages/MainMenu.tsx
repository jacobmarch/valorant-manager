  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#241016,#0a0a0d_55%)] px-4 py-10 text-ink">
      <section className="mx-auto max-w-5xl rounded-3xl border border-border bg-surface/90 p-8 shadow-2xl">
        ...
        <h1 className="mt-3 font-display text-4xl font-bold tracking-tight md:text-5xl">Valorant Manager</h1>
        ...
        <label className="mt-8 block max-w-sm">
          ...
          <input
            className="mt-2 w-full rounded-md border border-border bg-surface-2 px-4 py-3 text-ink outline-none transition focus:border-valorant focus:ring-2 focus:ring-valorant/40"
            value={managerName}
            ...
            return (
              <button
                ...
                className={`overflow-hidden rounded-lg border text-left transition ${
                  selected ? 'border-valorant bg-valorant/10 ring-1 ring-valorant/40' : 'border-border bg-surface-2 hover:border-border-strong'
                }`}
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="rounded-lg bg-surface-3 px-2 py-1 text-center">
                      ...
                      <p className="font-display tnum text-lg font-bold text-valorant-bright">{getTeamOverall(team)}</p>
                    </div>
                  </div>
