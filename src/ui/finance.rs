                ...
                ui.horizontal(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            ui.label(egui::RichText::new(format!("${}", game_state.budget))
                                .color(if game_state.budget > 0 { egui::Color32::GREEN } else { egui::Color32::RED }));
                        });
                        ...
                        for &player_id in &team.players {
                            if let Some(player) = game_state.get_player_by_id(player_id) {
                                total_salaries += player.contract_salary / 12; // Monthly salary
                            }
                        }
                        ...
                        ui.horizontal(|ui| {
                            ...
                            ui.label(egui::RichText::new(format!("${}", monthly_income)).color(egui::Color32::GREEN));
                        });
                        
                        ui.horizontal(|ui| {
                            ui.label("Monthly Expenses:");
                            ui.label(egui::RichText::new(format!("${}", total_expenses)).color(egui::Color32::RED));
                        });
                        
                        ui.horizontal(|ui| {
                            ui.label("Net Monthly:");
                            ui.label(egui::RichText::new(format!("${}", net_monthly))
                                .color(if net_monthly > 0 { egui::Color32::GREEN } else { egui::Color32::RED }));
                        });
                        ...
                        ui.horizontal(|ui| {
                            ...
                            ui.label(egui::RichText::new(format!("${}", six_month_projection))
                                .color(if six_month_projection > 0 { egui::Color32::GREEN } else { egui::Color32::RED }));
                        });
                        
                        if six_month_projection < 0 {
                            ui.colored_label(egui::Color32::RED, "⚠ Warning: Budget will go negative!");
                        }
                    });

                    ui.separator();

                    // Right panel - Player contracts and transfer budget
                    ui.vertical(|ui| {
                            ...
                            for &player_id in &team.players {
                                if let Some(player) = game_state.get_player_by_id(player_id) {
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        if ui.small_button("Negotiate").clicked() {
                        ...
                        let available_for_transfers = (game_state.budget * 30 / 100).max(0); // 30% of budget available for transfers
                        ui.horizontal(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            ui.label("$0"); // TODO: Track prize money
                        });
                        ...
                        if ui.button("Request Loan").clicked() {
                            // TODO: Implement loan system
                        }
                        
                        if ui.button("Increase Marketing Budget").clicked() {
                            // TODO: Implement marketing investment
                        }
                        
                        if ui.button("Upgrade Facilities").clicked() {
                            // TODO: Implement facility upgrades
                        }
                    });
                });
            } else {
